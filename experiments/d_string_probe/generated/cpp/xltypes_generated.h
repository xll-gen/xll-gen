...
template<> struct AnyValueTraits<ipc::types::Array> {
  static const AnyValue enum_value = AnyValue_Array;
};

template<> struct AnyValueTraits<ipc::types::NumArray> {
  static const AnyValue enum_value = AnyValue_NumArray;
};
...
struct ArrayBuilder {
  ...
  void add_rows(int32_t rows) {
    fbb_.AddElement<int32_t>(Array::VT_ROWS, rows, 0);
  }
  void add_cols(int32_t cols) {
    fbb_.AddElement<int32_t>(Array::VT_COLS, cols, 0);
  }
  void add_data(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<ipc::types::Scalar>>> data) {
    fbb_.AddOffset(Array::VT_DATA, data);
  }
...
struct NumArray FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef NumArrayBuilder Builder;
  enum FlatBuffersVTableOffset FLATBUFFERS_VTABLE_UNDERLYING_TYPE {
    VT_ROWS = 4,
    VT_COLS = 6,
    VT_DATA = 8
...
struct NumArrayBuilder {
  typedef NumArray Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_rows(int32_t rows) {
    fbb_.AddElement<int32_t>(NumArray::VT_ROWS, rows, 0);
  }
  void add_cols(int32_t cols) {
    fbb_.AddElement<int32_t>(NumArray::VT_COLS, cols, 0);
  }
  void add_data(::flatbuffers::Offset<::flatbuffers::Vector<double>> data) {
    fbb_.AddOffset(NumArray::VT_DATA, data);
  }
  explicit NumArrayBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<NumArray> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<NumArray>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<NumArray> CreateNumArray(
    ::flatbuffers::FlatBufferBuilder &_fbb,
    int32_t rows = 0,
    int32_t cols = 0,
    ::flatbuffers::Offset<::flatbuffers::Vector<double>> data = 0) {
  NumArrayBuilder builder_(_fbb);
  builder_.add_data(data);
  builder_.add_cols(cols);
  builder_.add_rows(rows);
  return builder_.Finish();
...
inline ::flatbuffers::Offset<NumArray> CreateNumArrayDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
    int32_t rows = 0,
    int32_t cols = 0,
    const std::vector<double> *data = nullptr) {
  auto data__ = data ? _fbb.CreateVector<double>(*data) : 0;
  return ipc::types::CreateNumArray(
      _fbb,
      rows,
      cols,
      data__);
...
struct Any FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  ...
  const ipc::types::Array *val_as_Array() const {
    return val_type() == ipc::types::AnyValue_Array ? static_cast<const ipc::types::Array *>(val()) : nullptr;
  }
  const ipc::types::NumArray *val_as_NumArray() const {
    return val_type() == ipc::types::AnyValue_NumArray ? static_cast<const ipc::types::NumArray *>(val()) : nullptr;
  }
...
template<> inline const ipc::types::Array *Any::val_as<ipc::types::Array>() const {
  return val_as_Array();
}

template<> inline const ipc::types::NumArray *Any::val_as<ipc::types::NumArray>() const {
  return val_as_NumArray();
}
...
inline bool VerifyAnyValue(::flatbuffers::Verifier &verifier, const void *obj, AnyValue type) {
  switch (type) {
    ...
    case AnyValue_Array: {
      auto ptr = reinterpret_cast<const ipc::types::Array *>(obj);
      return verifier.VerifyTable(ptr);
    }
    case AnyValue_NumArray: {
      auto ptr = reinterpret_cast<const ipc::types::NumArray *>(obj);
      return verifier.VerifyTable(ptr);
    }
    case AnyValue_Range: {
